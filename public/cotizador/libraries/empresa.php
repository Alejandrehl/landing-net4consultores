	<?php
				...
				)
			{
				...
				$logo_update=" ,logo_url='$target_file' ";
                    ...
                    $sql = "UPDATE empresa SET nombre='".$nombre."', propietario='".$propietario."',  direccion='".$direccion."', telefono='".$telefono."', email='".$email."', giro='".$giro."',  iva='".$iva."', nrc='".$nrc."', iva='".$iva."', moneda='".$moneda."' $logo_update
                            WHERE id_empresa='1';";
