...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg></a></li>
						...
						<form  role="form" enctype="multipart/form-data" method="post" >
							...
							<div class="row">
								...
								<div class="col-xs-12 col-md-6 form-group">
									...
									<input class="form-control" name="moneda" id="moneda" type="text" value="<?php echo $moneda;?>" maxlength='3' required />
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12 col-md-6 form-group">
