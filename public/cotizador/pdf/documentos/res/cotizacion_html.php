...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 13px; font-family: helvetica" >
    ...
    <p style="width:100%;text-align:right;margin-right:10mm"><strong>Fecha:</strong> <?php echo date("d/m/Y");?></p>
	
  <table style="width:100%" class="table-bordered">
		<tr style="vertical-align: top">
            <td style="width:80%"><strong>Atención: </strong> <?php echo $atencion; ?></td>
			<td style="width:20%;"><strong>Teléfono:</strong> <?php echo $tel1; ?></td>
		</tr>
		<tr style="vertical-align: top">
            <td style="width:80%"><strong>Empresa: </strong> <?php echo $empresa ?></td>
			<td style="width:20%;"><strong>Teléfono:</strong> <?php echo $tel2; ?></td>
		</tr>
		<tr style="vertical-align: top">
            <td style="width:80%"><strong>E-mail: </strong> <?php echo $email ?></td>
...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            ...
            <td class="left" style="width: 14%; text-align: right"><?php echo $precio_venta_f;?></td>
            <td class="left" style="width: 12%; text-align: right"><?php echo number_format($total_descuento,2);?></td>
			<td class="left" style="width: 14%; text-align: right"><?php echo $precio_total_f;?></td>
            
        </tr>
    
	<?php 
	//Insert en la tabla detalle_cotizacion
	$insert_detail=mysqli_query($con, "INSERT INTO detail_estimate VALUES ('','$numero_cotizacion','$id_producto','$cantidad','$descuento_percent','$precio_venta_r')");
	}
...
?>	
	<tr style="vertical-align: top">
			...
			<?php echo number_format($total_parcial,2);?>
			</td>
		</tr>
		<tr style="vertical-align: top">
			...
			<?php echo number_format($sumador_descuento,2);?>
			</td>
		</tr>
		<tr style="vertical-align: top">
			<td class="" colspan=4 style="text-align:right">
...
$insert=mysqli_query($con,"INSERT INTO estimates VALUES ('','$numero_cotizacion','$date','$condiciones','$validez','$entrega','0','$notas','$user_id','$id_cliente','$total_neto','$total_iva')");
