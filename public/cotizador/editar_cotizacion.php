						...
						<form class="form-horizontal" role="form" id="datos_cotizacion">
							<div class="form-group row">
							  ...
							  <label for="atencion" class="col-md-1 control-label">Atención:</label>
								<div class="col-md-2">
									<input type="text" class="form-control input-sm" id="atencion" placeholder="" value="<?php echo $contacto;?>"  readonly>
								</div>
								
								<label for="tel1" class="col-md-1 control-label">Teléfono:</label>
								<div class="col-md-2">
									<input type="text" class="form-control input-sm" id="tel1" placeholder="" value="<?php echo $movil;?>" readonly>
								</div>
							</div>
							<div class="form-group row">
