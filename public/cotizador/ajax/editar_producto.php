<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', modelo_producto='".$modelo."', id_marca_producto='".$fabricante."', status_producto='".$estado."', precio_producto='".$precio_venta."' WHERE id_producto='".$id_producto."'";
