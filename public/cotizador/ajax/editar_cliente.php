<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE  clients SET nombre_cliente='$cliente', nombre_comercial='$nombre_comercial', numero_identificacion='$registro',giro='$giro',direccion='$direccion',  email='$email', fijo='$fijo', movil='$movil', contacto='$contacto' WHERE id='$id_cliente'";
