<?php
	...
	if (empty($_POST['cliente'])) {
		...
		$movil=mysqli_real_escape_string($con,(strip_tags($_POST["movil"],ENT_QUOTES)));
		$contacto=mysqli_real_escape_string($con,(strip_tags($_POST["contacto"],ENT_QUOTES)));
		$date_added=date("Y-m-d H:i:s");
		$sql="INSERT INTO clients (nombre_cliente, nombre_comercial, numero_identificacion,giro,direccion, email, fijo, movil, contacto, fecha_agregado) VALUES ('$cliente','$nombre_comercial','$registro','$giro','$direccion','$email','$fijo','$movil','$contacto','$date_added')";
